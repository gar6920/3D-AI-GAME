@echo off
echo Launching 3D AI Game in PRODUCTION mode...

REM Set environment - PRODUCTION
set ENVIRONMENT=production
set SERVER_URL=https://ea-lion-app-4mc79.ondigitalocean.app

echo Running in PRODUCTION environment, connecting to %SERVER_URL%
